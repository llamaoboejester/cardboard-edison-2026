...
The first player is the player whose wedding is the closest (either in the past or future). Alternatively, randomly determine the first player. Give them the First Player token.
...
After everyone completes their turn for months 3, 6, and 9, perform a **Check-In** (see **Check-Ins** section).

After month 12, proceed directly to **End of Game** (no Check-In).
...
3. **Nature** (green leaf) - Organic, natural, outdoor
...
Your excitement track runs from 0-30. The tracker stops at position 30. No further progress or bonuses beyond that. At every 5 positions (5, 10, 15, 20, 25, 30), choose one:
- Gain 1 coin, OR
...
At Check-In, choose one of these 9 Guest Goals:
- **Admired:** Photography vendors
- **Amazed:** Flowers & Decorations vendors
- **Captivated:** Entertainment vendors
- **Honored:** Stationery vendors
- **Impressed:** Attire & Accessories vendors
- **Indulged:** Food & Drink vendors
- **Moved:** Ceremony vendors
...
- **2 vendors** in chosen category: **10 gifts**
- **1 vendor** in chosen category: **5 gifts**
...
2. Set Theme (Check-In 1 only)
3. Set 1 new Goal (private or public)
4. Clear FVR
5. Pass First Player token
...
© 2026 Llama Oboe Jester. All rights reserved.
